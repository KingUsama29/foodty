...
@section('sidebar-menu')
    ...
    <a href="{{ route('penerima.riwayat') }}" class="list-group-item list-group-item-action active d-flex align-items-center">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="card h-100">
                                <img src="{{ asset('gambar/balita.jpg') }}" class="card-img-top" alt="Foto KTP">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="card h-100">
                                <img src="{{ asset('gambar/balita.jpg') }}" class="card-img-top" alt="Foto Selfie + KTP">
                                <div class="card-body text-center small fw-semibold">
                                    Foto Selfie + KTP
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="card h-100">
                                <img src="{{ asset('gambar/balita.jpg') }}" class="card-img-top" alt="Foto KK">
                                <div class="card-body text-center small fw-semibold">
                                    Foto Kartu Keluarga
                                </div>
                            </div>
