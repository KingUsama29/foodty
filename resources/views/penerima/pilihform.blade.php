        ...
        <div class="card-body p-4 p-md-5">
            ...
            <form method="POST" action="{{ route('verifikasi.logic') }}" enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-12 col-md-4 text-center">
                    ...
                    <input type="file" class="form-control" accept="image/*" onchange="previewImage(this, 'previewKtp')">
                ...
                <div class="col-12 col-md-4 text-center">
                    ...
                    <input type="file" class="form-control" accept="image/*" onchange="previewImage(this, 'previewKk')">
                    <img id="previewKk" class="img-fluid rounded shadow-sm mt-2 d-none" style="max-height:180px;">
                </div>

                {{-- INPUT DATA --}}
                <div class="col-12 col-md-6">
                    <input type="text" class="form-control rounded-pill shadow-sm" placeholder="Nama (sesuai KTP)">
                </div>

                <div class="col-12 col-md-6">
                    <input type="tel" class="form-control rounded-pill shadow-sm" placeholder="No Telepon Aktif">
                </div>
                ...
                <div class="col-12 col-md-6">
                    <input type="text" class="form-control rounded-pill shadow-sm" placeholder="Nomor KK">
                </div>

                <div class="col-12">
                    <textarea class="form-control rounded-4 shadow-sm" rows="3" placeholder="Alamat"></textarea>
                </div>

                <div class="col-12">
                    <textarea class="form-control rounded-4 shadow-sm" rows="3" placeholder="Deskripsi (Opsional)"></textarea>
                </div>
